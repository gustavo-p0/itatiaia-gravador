...
export default function FileList({ files, currentFileId, onSelect }: FileListProps) {
  ...
  return (
    <div className="h-[126px] overflow-y-auto space-y-1">
      {files.map((file) => {
        ...
        return (
          ...
          >
            <div className="w-6 h-6 rounded flex items-center justify-center shrink-0" style={{ backgroundColor: isActive ? '#8b6b3d' : '#2d1b14', border: '1px solid #4a3020' }}>
