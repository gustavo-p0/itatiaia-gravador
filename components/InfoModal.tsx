...
export default function InfoModal() {
  ...
  return (
    <div className="flex flex-col gap-2">
      <a
        href={`https://wa.me/${whatsappNumber}?text=Ola%20Gut,%20ola%20Tinelao!`}
        target="_blank"
      ...
      >
        ...
        <span className="text-sm font-medium text-white">Falar com o Gut e Tinelão</span>
      </a>
      ...
      >
        ...
        <svg viewBox="0 0 24 24" className="w-4 h-4 ml-auto" style={{ color: '#8b6b3d', transform: isOpen ? 'rotate(180deg)' : 'rotate(0)', transition: 'transform 0.2s' }} fill="currentColor">
          <path d="M7.41 8.59L12 13.17l4.59-4.58L18 10l-6 6-6-6z"/>
        </svg>
      </button>

      {isOpen && (
        <div className="p-3 rounded-lg" style={{ background: 'linear-gradient(180deg, #3d2b1f 0%, #2d1b14 100%)', border: '1px solid #4a3020' }}>
